...
for fileName in os.listdir(blifDir):
  ...
  os.system(vprDir+"vpr "+xmlFile+" "+outputDir+benchmark+"/"+fileName+" "+vprOptions+" "+str(value)+" > /dev/null") 
  with open ('vpr_stdout.log') as vpr_output:
    if 'Routing failed' in vpr_output.read():
      ...
      os.system(vprDir+"vpr "+xmlFile+" "+outputDir+benchmark+"/"+fileName+" "+vprOptions+" "+str(value-2)+" > /dev/null") 
  with open ('vpr_stdout.log') as vpr_output:
    if 'Routing failed' in vpr_output.read():
